  ...
  return (
    <div>
      ...
      {showAlert && alertType === 'success' && (
        <Alert alertTitle={'YEAY, SUCCESSFULLY!'} textColor="text-green-800" borderColor="border-green-800" bgColor="bg-green-200" />
      )}
      {showAlert && alertType === 'warning' && (
        <Alert alertTitle={'WARNING'} textColor="text-yellow-800" borderColor="border-yellow-800" bgColor="bg-yellow-200"/>
      )}
      {showAlert && alertType === 'error' && (
        <Alert alertTitle={'ERROR'} textColor="text-red-800" borderColor="border-red-800" bgColor="bg-red-200"/>
      )}
    </div>
  );
}
